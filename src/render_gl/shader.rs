...
impl Program
{
	...
	pub fn from_shaders(shaders: &[Shader]) -> Result<Program, String>
	{
		...
		unsafe
		{
			// GetProgramiv and GetShaderiv return the value of a specified parameter for a program/shader object
...
fn shader_from_source(source: &CStr, kind: gl::types::GLenum) -> Result<gl::types::GLuint, String>
{
	...
	if success == 0
	{
		...
		// to_string_lossy() converts CString to rust String.
		// it could return either String or &str, and using into_owned() guarantees String
		return Err(error.to_string_lossy().into_owned());
	}
